...
3. make a Logistic Regression model based on song lyric data (helpful examples/guides for model architecture: Kulmizev and Perkins)
4. evaluate model
5. if not to standards: look into making it into an ensemble model with SVM
